...
?>			<script>
				...
				(function($) {
					$(function() {
						var mediaUploader,
							simpleMediaButton = $( '.simple-media-upload' ),
							simpleMediaAttachment;
						
						simpleMediaButton.click( function( e ) {
							e.preventDefault();
							var simpleMediaDestination = $( this ).prev( 'input' );
							...
							mediaUploader.on( 'select', function() {
								simpleMediaAttachment = mediaUploader.state().get('selection').first().toJSON();
								simpleMediaDestination.val( simpleMediaAttachment.url );
							} );
		...
		switch ( $field['type'] ) {
			...
			case 'media':
				$upload_button = sprintf(
					'<input class="button simple-media-upload" type="button" value="Upload">'
				);
				printf(
